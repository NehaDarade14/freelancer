...
<html lang="en">
<head>
<title>{{ $allsettings->site_title }} - @if(Auth::user()->id != 1) Project Dashboard @else {{ __('404 Not Found') }} @endif</title>
@include('meta')
@include('style')
</head>
<body>
    ...
    <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            ...
            <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-star">
                ...
                <li class="breadcrumb-item text-nowrap active" aria-current="page">Project Dashboard</li>
            </ol>
            </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
            <h1 class="h3 mb-0 text-white">Project Dashboard</h1>
        </div>
    </div>
</div>
